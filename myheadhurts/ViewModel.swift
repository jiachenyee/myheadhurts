...
class ViewModel: ObservableObject {
    ...
    func headacheRecord(for headache: Headache) -> HKCategorySample {
    ...
    func presenceRecord(for headache: Headache,
    ...
    func faintingRecord(for headache: Headache) -> HKCategorySample {
